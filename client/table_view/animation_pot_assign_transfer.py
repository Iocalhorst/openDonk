class AnimationPotAssignTransfer():
      def __init__(self,pot_widget,player_info_widget,seat_widget,value):

          #visual/business transfer origin
          self.pot_widget=pot_widget
          #business transfer target
          self.player_info_widget=player_info_widget
          #"visual" transfer target
          ...
          self.pending=True
          self.finished=False
          self.origin_rel_x=pot_widget.rel_x
          self.origin_rel_y=pot_widget.rel_y
      ...
      def start_at(self,moment_of_time):
          assert self.is_pending()==True,"Failed to start pot_assign animation, reson : is_pending()!=True"
          ...
          self.running=True
          self.finished=False
          self.seat_widget.pending_chips_inline+=self.value
